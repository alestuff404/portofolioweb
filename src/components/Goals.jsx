    ...
    <section className="w-full bg-[#fef1e6] text-black py-10 px-4 md:px-20">
      <div className="flex flex-col md:flex-row justify-between items-start gap-10">
        ...
        <div className="md:w-1/2">
          <h2 className="text-2xl font-bold underline decoration-[#876445] mb-2">Future Goals: Bridging AI and Medicine for Humanity</h2>
          ...
          <h2 className="text-2xl font-bold underline decoration-[#876445] mt-4 mb-2">Long-Term Vision: Intelligent Medical Personal Assistant (IMPA)</h2>
          <p className="text-base leading-relaxed text-neutral-800">
        ...
        <div className="md:w-1/2 flex justify-center items-center -mt-4">
          <img
            ...
            className="w-[340px] max-w-md object-contain"
          />
        </div>
      </div>
      ...
      <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-8">
        ...
        <div className="bg-[#EAD8C0] p-6 rounded-xl shadow-md">
          <h3 className="text-xl font-semibold underline decoration-[#876445] mb-3">🔍 Key Capabilities of IMPA</h3>
          <ul className="list-disc list-outside pl-6 text-sm text-black leading-relaxed space-y-4">
            <li>
                Natural and Emotional Interaction: Understand tone, word choices, and facial expressions to respond like a human companion.
            </li>
            <li>
                Real-Time Condition Monitoring: Sync with wearable devices or user input (heart rate, sleep data, stress level).
            </li>
            <li>
                Responsible Early Medical Advice: Give health recommendations based on verified medical data and refer users to professionals if needed.
            </li>
            <li>
                Personalized Response Based on History: Learn from previous interactions to understand the user better over time.
            </li>
            </ul>
        ...
        {/* Box Kanan */}
        <div className="bg-[#EAD8C0] p-6 rounded-xl shadow-md">
          <h3 className="text-xl font-semibold underline decoration-[#876445] mb-3">💡 My Strategic Roadmap</h3>
  <ul class="list-decimal list-inside space-y-3 text-sm leading-relaxed">
    <li>
